...
public class WxMpConstants {
	  ...
	  public static final String MEDIA_IMG_UPLOAD_URL = "https://api.weixin.qq.com/cgi-bin/media/uploadimg";
	  
	  public static final String MATERIAL_ADD_URL = "https://api.weixin.qq.com/cgi-bin/material/add_material?type=%s";
	  public static final String MATERIAL_NEWS_ADD_URL = "https://api.weixin.qq.com/cgi-bin/material/add_news";
	  public static final String MATERIAL_GET_URL = "https://api.weixin.qq.com/cgi-bin/material/get_material";
	  public static final String MATERIALNEWS_UPDATE_URL = "https://api.weixin.qq.com/cgi-bin/material/update_news";
	  ...
	  public static final String BASE_ACCESS_TOKEN_URL = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid={0}&secret={1}";
	  public static final String BASE_JSAPI_TICKET_URL = "https://api.weixin.qq.com/cgi-bin/ticket/getticket?type=jsapi";

	  public static final String CALLBACK_CHECK_URL = "https://api.weixin.qq.com/cgi-bin/callback/check";
	  ...
	  public static final String KFACCOUNT_UPLOAD_HEAD_IMG = "https://api.weixin.qq.com/customservice/kfaccount/uploadheadimg?kf_account={0}";
	  public static final String KFACCOUNT_DEL = "https://api.weixin.qq.com/customservice/kfaccount/del?kf_account={0}";
	  ...
	  public static final String KFSESSION_GET_SESSION = "https://api.weixin.qq.com/customservice/kfsession/getsession?openid={0}";
	  public static final String KFSESSION_GET_SESSION_LIST = "https://api.weixin.qq.com/customservice/kfsession/getsessionlist?kf_account={0}";
	  public static final String KFSESSION_GET_WAIT_CASE = "https://api.weixin.qq.com/customservice/kfsession/getwaitcase";
	  public static final String MSGRECORD_GET_MSG_LIST = "https://api.weixin.qq.com/customservice/msgrecord/getmsglist";
	  
	  public static final String BASE_ACCESS_TOKEN_KEY = "wx.mp.base.access-token";
	  public static final String BASE_JSAPI_TICKET_KEY = "wx.mp.base.jsapi-ticket";
	  public static final String BASE_JSAPI_SIGN_KEY = "wx.mp.base.jsapi:sign";
